  ...
  <div>
    <el-container>
      <el-header>
        ...
        <div id="account">
          <img
            :src="this.$store.getters.getUser.headImage"
            alt="网络不好"
            :title="'管理员：' + this.$store.getters.getUser.username"
            id="headImage"
          />
      ...
      <el-container>
        <el-aside width="250px">
          <el-menu :default-active="currentActive" router>
            ...
            <el-menu-item index="usersSetting">
              <img src="@/assets/users_icon.png" class="icon" />
...
export default {
  ...
  methods: {
    loginOut() {
      this.$axios.post('http://localhost:8080/sign/loginOut').then((res) => {
        if (res.data.state) {
